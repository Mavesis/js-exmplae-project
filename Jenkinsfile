      ...
      stage('FASE 2 ANALYSIS JS '){
        steps{
          ...
          withSonarQubeEnv('local_sonar'){
            ...
            bat "\"${scannerHome}\\bin\\sonar-scanner\" -Dsonar.projectKey=ProyectoJS -Dsonar.organization=mavesis-github -Dsonar.sources=. -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=39acfca66c299343b8ac4427b69b5cb78db97cf1 "
          }
        }
      }
  }
